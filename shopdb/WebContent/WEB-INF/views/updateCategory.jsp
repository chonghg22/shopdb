		...
		<div class="wrapper wrapper--w790">
			<div class="card card-5">
				<div class="card-heading">
					<h2 class="title">Insert Subject Content</h2>
				</div>
				<div class="card-body">
					<form method = "post" action = "${pageContext.request.contextPath}/UpdateCategory">
						<div class="form-row">
							<div class="name">
							categoryId:
							</div>
								...
								<div class="input-group">
									<input class="input--style-5" type = "text" name = "categoryId" value = "${c.categoryId}" readonly>
								</div>
							</div>
						</div>
						<div class="form-row">
							...
							categoryName:
								...
								<div class="value">
								<div class="input-group">
									<input class="input--style-5" type = "text" name = "categoryName" value = "${c.categoryName}">
								</div>
							</div>
						</div>
						<div>
